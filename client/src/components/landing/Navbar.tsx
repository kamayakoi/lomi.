...
export const Navbar = () => {
  ...
  return (
    <>
      <div className="navbar-placeholder"></div> {/* Placeholder for the fixed navbar */}
      <header className="navbar-fixed border-b-[1px] dark:border-b-slate-700 dark:bg-background">
