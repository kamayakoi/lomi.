...
export const FooterAbout = () => {
    ...
    return (
        <footer id="footer" className="bg-[#06060A] py-10 w-full">
            <div className="container max-w-8xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-8 mb-16 px-4">
                ...
                <div className="grid gap-2 col-span-1 sm:col-span-1 md:col-span-2 ml-2 md:ml-14">
                    ...
                    <nav className="grid gap-2">
                        <a onClick={(e) => e.preventDefault()} href="#" style={{ cursor: 'default' }} className="hover:underline text-gray-400">
                            {t('footer.solutions')}
                        </a>
                        <a onClick={(e) => e.preventDefault()} href="#" style={{ cursor: 'default' }} className="hover:underline text-gray-400">
                ...
                <div className="grid gap-2 col-span-1 sm:col-span-1 md:col-span-2 ml-2 md:ml-14">
                    ...
                    <nav className="grid gap-2">
                        <a href="https://developers.lomi.africa/" className="hover:underline text-gray-400">
                            {t('footer.developers')}
                        </a>
                        <a href="https://developers.lomi.africa/api-documentation" className="hover:underline text-gray-400">
                            {t('footer.recipes')}
                        </a>
                        <a href="mailto:hello@lomi.africa?subject=[Support] — Question" className="hover:underline text-gray-400">
                            {t('footer.support')}
                        </a>
                        <a onClick={(e) => e.preventDefault()} href="#" style={{ cursor: 'default' }} className="hover:underline text-gray-400">
                            {t('footer.pricing')}
                ...
                <div className="grid gap-2 col-span-1 sm:col-span-1 md:col-span-2 ml-2 md:ml-14">
                    ...
                    <nav className="grid gap-2">
                        ...
                        <a onClick={(e) => e.preventDefault()} href="#" style={{ cursor: 'default' }} className="hover:underline text-gray-400 whitespace-nowrap">
                ...
                <div className="hidden md:block md:col-span-1 border-r border-gray-700"></div>
            ...
            <div className="container max-w-8xl mt-8 flex flex-col md:flex-row items-center justify-between text-xs text-gray-400 px-4">
                <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6 mb-4 md:mb-0 ml-2 md:ml-[55px]">
                    ...
                    <div className="flex items-center gap-4 md:gap-6">
                        ...
                        <a href="https://maps.app.goo.gl/maQA72wpgb3nVGQ46" target="_blank" rel="noopener noreferrer" className="hover:underline text-gray-400 whitespace-nowrap">
                            {t('footer.address')}
                        </a>
                        <div className="flex items-center gap-4 md:gap-6">
                            <a onClick={(e) => e.preventDefault()} href="#" style={{ cursor: 'default' }} className="hover:underline text-gray-400">
                            ...
                            <button onClick={toggleLanguage} className="hover:underline text-gray-400">
