                ...
                <div className="flex flex-col justify-center">
                    <Square ref={div6Ref} className="size-20 relative">
                        ...
                        <img
                            ...
                            alt="lomi."
                            className="relative z-10 object-contain w-18 h-18 rounded-sm transition-all duration-300 hover:scale-110"
                        />
                    </Square>
                </div>
                <div className="flex flex-col justify-center gap-1">
                    <Square ref={div1Ref} className="size-14">
                        <img src="/payment_channels/visa.webp" alt="Visa" className="object-cover w-full h-full rounded-sm" />
                    </Square>
                    <Square ref={div2Ref} className="size-14">
                        <img src="/payment_channels/mastercard.webp" alt="Mastercard" className="object-cover w-full h-full rounded-sm" />
                    </Square>
                    <Square ref={div3Ref} className="size-14">
                        <img src="/payment_channels/paypal.webp" alt="PayPal" className="object-cover w-full h-full rounded-sm" />
                    </Square>
                    <Square ref={div4Ref} className="size-14">
                        <img src="/payment_channels/orange.webp" alt="Orange Money" className="object-cover w-full h-full rounded-sm" />
                    </Square>
                    <Square ref={div5Ref} className="size-14">
                        <img src="/payment_channels/mtn.webp" alt="MTN" className="object-cover w-full h-full rounded-sm" />
                    </Square>
                    <Square ref={div10Ref} className="size-14">
                        <img src="/payment_channels/wave.webp" alt="Wave" className="object-cover w-full h-full rounded-sm" />
                    </Square>
                    <Square ref={div11Ref} className="size-14">
                        <img src="/payment_channels/airtel.webp" alt="Airtel" className="object-cover w-full h-full rounded-sm" />
                    </Square>
                    <Square ref={div12Ref} className="size-14">
                        <img src="/payment_channels/wizall.webp" alt="Wizall" className="object-cover w-full h-full rounded-sm" />
                    </Square>
                    <Square ref={div13Ref} className="size-14">
                        <img src="/payment_channels/moov.webp" alt="Moov" className="object-cover w-full h-full rounded-sm" />
                    </Square>
                </div>
            </div>
