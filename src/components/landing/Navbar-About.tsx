...
export const Navbar = () => {
  ...
  return (
    <header className="fixed border-b-[1px] top-0 z-40 w-full bg-white/2 backdrop-blur-sm dark:bg-transparent border-b-slate-700 dark:border-b-slate-700">
      <NavigationMenu className="mx-auto">
        <NavigationMenuList className="container h-16 px-4 w-screen flex items-center">
