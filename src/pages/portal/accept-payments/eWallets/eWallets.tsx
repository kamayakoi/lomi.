            ...
            <Layout.Body>
                <div className="space-y-4">
                    <div className="flex justify-between items-center">
                        <h1 className="text-2xl font-bold tracking-tight">E-Wallet Payments</h1>
                    </div>
                    ...
                    <Card>
                        <CardContent className="p-6 flex flex-col items-center justify-center min-h-[300px]">
                            ...
                            <CardTitle className="text-xl mb-2">There are no e-wallet payments found</CardTitle>
                            <CardDescription className="text-center">
                                Please adjust the filter or create new e-wallet transactions
                            </CardDescription>
                            <Button className="mt-4">Create E-Wallet Transaction</Button>
                        </CardContent>
                    </Card>
                </div>
            </Layout.Body>
