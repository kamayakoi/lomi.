            ...
            <div className="bg-background text-dark-text dark:text-light-text"> {/* Adjust text color for light and dark modes */}
                ...
                <main className="container mx-auto max-w-6xl px-8 py-12 sm:px-10 lg:px-12">
                    <div className="space-y-12"> {/* Increased space between sections */}
                        <div>
                            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl scroll-mt-32">{/* Added scroll-mt-32 */}Terms and Conditions</h1>
                        ...
                        <div className="space-y-10"> {/* Increased space between subsections */}
                            <div>
                                ...
                                <p className="mt-6 text-lg text-muted-foreground"> {/* Increased font size and margin */}
                                    The First Party shall be entitled to amend, modify, or supplement the Conditions at any time and (subject to law) for an unlimited number of times subsequently without restriction in its sole and absolute discretion by posting a revised version of these Conditions. The First Party will provide fourteen (14) calendar days&apos; prior notice (&quot;Notice Period&quot;) to the Second Party before the effective date of any amendment, modification, or supplement. Such notice will be given via electronic mail transmission or otherwise in writing.
                                    <br />
                                    <br />
                            ...
                            <div id="interpretation" className="scroll-mt-32"> {/* Added scroll-mt-32 */}
                            ...
                            <div id="service-fees" className="scroll-mt-32"> {/* Added scroll-mt-32 */}
                            ...
                            <div id="disbursement-services" className="scroll-mt-32"> {/* Added scroll-mt-32 */}
                            ...
                            <div id="collection-services" className="scroll-mt-32"> {/* Added scroll-mt-32 */}
                            ...
                            <div id="card-processing-services" className="scroll-mt-32"> {/* Added scroll-mt-32 */}
                            ...
                            <div id="invalid-payments-and-other-liabilities" className="scroll-mt-32"> {/* Added scroll-mt-32 */}
                            ...
                            <div id="security-and-fraud" className="scroll-mt-32"> {/* Added scroll-mt-32 */}
                            ...
                            <div id="license-and-intellectual-property" className="scroll-mt-32"> {/* Added scroll-mt-32 */}
                            ...
                            <div id="representations-and-warranties" className="scroll-mt-32"> {/* Added scroll-mt-32 */}
                                <h2 className="text-3xl font-bold">Representations and Warranties</h2> {/* Section title */}
                                <p className="mt-6 text-lg text-muted-foreground"> {/* Section content */}
                            ...
                            <div id="restricted-activities" className="scroll-mt-32"> {/* Added scroll-mt-32 */}
                                <h2 className="text-3xl font-bold">Restricted Activities</h2> {/* Section title */}
                                <p className="mt-6 text-lg text-muted-foreground"> {/* Section content */}
                            ...
                            <div id="disclaimers" className="scroll-mt-32"> {/* Added scroll-mt-32 */}
                                <h2 className="text-3xl font-bold">Disclaimers</h2> {/* Section title */}
                                <p className="mt-6 text-lg text-muted-foreground"> {/* Section content */}
                            ...
                            <div id="indemnification-and-liability" className="scroll-mt-32"> {/* Added scroll-mt-32 */}
                                <h2 className="text-3xl font-bold">Indemnification and Liability</h2> {/* Section title */}
                                <p className="mt-6 text-lg text-muted-foreground"> {/* Section content */}
                            ...
                            <div id="confidential-information" className="scroll-mt-32"> {/* Added scroll-mt-32 */}
                                <h2 className="text-3xl font-bold">Confidential Information</h2> {/* Section title */}
                                <p className="mt-6 text-lg text-muted-foreground"> {/* Section content */}
                            ...
                            <div id="miscellaneous" className="scroll-mt-32"> {/* Added scroll-mt-32 */}
                                <h2 className="text-3xl font-bold">Miscellaneous</h2> {/* Section title */}
                                <p className="mt-6 text-lg text-muted-foreground"> {/* Section content */}
