...
Welcome to the documentation of [lomi.](https://lomi.africa), the open-source payment processing platform powering francophone West African businesses. This repository contains the code for the lomi. website, docs, and blog. Everything is built on top of modern web tooling, Sanity, and Fumadocs.
