...
Les changements non terminaux utilisent une enveloppe de type Stripe : état actuel dans `object`, ce qui a changé dans `previous_attributes`, et `context` optionnel pour le débogage.
