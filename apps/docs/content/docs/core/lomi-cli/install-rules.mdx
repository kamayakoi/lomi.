...
- First run of [`lomi init`](/core/lomi-cli/init) (unless `--skip-rules-install`)
- First run of [`lomi dev`](/core/lomi-cli/dev) (unless `--skip-rules-install`)
...
For manual AI setup without the CLI, see [API integration — agent setup](/reference/setup/integration).

## Next steps

- [Getting started](/core/lomi-cli/overview)
