...
Refer to the [Error reference](/reference/reference/errors) for a detailed list of status codes and common error responses.
...
- [Error Reference](/reference/reference/errors)
