...
Refer to the [Setting up webhooks](/core/fundamentals/webhooks) and [Handling webhooks](/core/advanced-guides/handling-webhooks) guides for detailed instructions.
...
- [Idempotency keys](/core/advanced-guides/idempotency-keys)
