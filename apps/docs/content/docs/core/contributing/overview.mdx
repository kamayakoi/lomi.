...
- **Writing code**: Contribute directly to the codebase by fixing bugs or implementing new features. See the [Best practices](/core/contributing/best-practices) guide.
...
- **[Code of Conduct](/core/contributing/code-of-conduct)**: Our expectations for behavior within the community.
- **[Best practices](/core/contributing/best-practices)**: Detailed steps for contributing code and documentation.
- **[Branching strategy](/core/contributing/branching-strategy)**: How we manage branches for development and releases.
...
Before making changes, create a new branch based on the `develop` branch. Follow our [Branching strategy](/core/contributing/branching-strategy) for naming conventions.
...
- **Code changes**: Write your code, ensuring it adheres to our [Code standards](/core/contributing/best-practices#code-standards) and [Best practices](/core/contributing/best-practices).
...
Write tests for your changes. See the [Code standards](/core/contributing/best-practices#code-standards) section for an example.

### Commit your changes

Commit your changes using a descriptive message that follows our [Commit message guidelines](/core/contributing/branching-strategy). Adhering to the format helps automate releases and changelogs.
...
See [Best practices](/core/contributing/best-practices) for good vs. bad commit message examples.
...
- Familiarize yourself with our [Code of conduct](/core/contributing/code-of-conduct).
- Understand our [Branching strategy](/core/contributing/branching-strategy).
- Learn about the [Code review](/core/contributing/code-reviews) process in more detail.

Your PR will be reviewed by maintainers according to our [Code Review](/core/contributing/code-reviews) process. Be prepared to respond to feedback and make further changes if necessary. We'll be fast to respond to you, don't you worry!
