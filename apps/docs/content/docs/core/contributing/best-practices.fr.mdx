...
Voir aussi [Variables d’environnement](/core/fundamentals/access-tokens).
...
Validez et assainissez les entrées utilisateur. Voir [vérification des signatures webhook](/core/advanced-guides/handling-webhooks).
...
Suivez notre [Stratégie de branches](/core/contributing/branching-strategy).
...
Versions dans chaque `package.json`, selon le guide [Versionnement](/core/contributing/versioning).
