...
Les noms exacts dans les réponses suivent OpenAPI / modèles ; voir [Transactions](/build/transactions).
...
Délais de disponibilité : [Solde et règlement](/build/balance-and-settlement).
