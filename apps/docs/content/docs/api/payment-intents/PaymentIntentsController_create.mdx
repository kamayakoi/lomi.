...
Creates a card PaymentIntent for Elements / Card integrations and exposes client_secret securely.
...
| `503` | Card payment processor is not configured on this API instance |
