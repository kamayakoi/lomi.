---
title: "Créer un intent de paiement carte (client_secret)"
description: "Créer un intent de paiement carte (client_secret)"
full: true
method: post
...
Utilisez cet endpoint quand vous devez exécuter `POST /payment-intents` (Créer un intent de paiement carte (client_secret)).
...
| Statut | Description |
| --- | --- |
| `201` | Intent de paiement créé avec succès |
