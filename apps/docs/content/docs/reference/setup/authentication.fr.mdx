...
Pour un parcours guidé depuis votre premier `curl` jusqu’aux pages OpenAPI, SDK et pièges webhooks : **[Intégration API](/reference/setup/integration)**.
...
Pour simuler les paiements carte et mobile money (numéros de test, Wave, MTN MoMo), voir **[Paiements en bac à sable](/reference/setup/sandbox-payments)**.
