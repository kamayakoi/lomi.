...
## 2. Full HTTP reference (OpenAPI)

The **canonical** list of paths, methods, parameters, security, and **request bodies** is the generated OpenAPI site:

- **[OpenAPI reference index](/openapi/generated/index)** — browse operations; each page includes **language tabs** (cURL, JavaScript, Go, Python, Java, and C#) and a **Try it** playground.
...
| --- | --- | --- |
| **Raw HTTP** | Maximum control, any stack, smallest dependency | This hub + [OpenAPI reference](/openapi/generated/index) |
...
For managing **your** outbound webhook subscriptions (list, get, update) over the merchant API, see [Webhooks](/reference/payments/webhooks) and the matching operations in the [OpenAPI reference](/openapi/generated/index).
