...
Détails de l’endpoint : [API Payment Intents](/reference/payments/payment-intents)
...
Pour les numéros de carte de test, le mobile money (Wave, MTN MoMo), la QA sur checkout hébergé et les soldes de test, voir **[Paiements en bac à sable](/reference/setup/sandbox-payments)**.
