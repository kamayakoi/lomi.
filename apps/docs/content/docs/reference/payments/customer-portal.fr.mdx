...
Les détails du point de terminaison et des exemples de charge utile figurent dans [Customers](/reference/platform/customers#create-customer-portal-launch-session).
