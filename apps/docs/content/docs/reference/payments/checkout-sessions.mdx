...
<Callout type="info">
  lomi. Network Operators can add `Lomi-Account: acct_...` to create a checkout session for a connected Member Account. The hosted checkout page uses the Member Account branding and providers.
</Callout>
