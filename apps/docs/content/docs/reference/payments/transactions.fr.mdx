...
<Callout type="info">
  **Comportement :** transitions de statut, crédit des soldes, expiration — voir **[Machine à états du paiement](/reference/reference/payment-state-machine)** et **[Solde et règlement](/reference/platform/balance-and-settlement)**.
</Callout>
