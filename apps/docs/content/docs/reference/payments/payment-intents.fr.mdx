...
<Callout type="info">
  Utilisez **`lomi_sk_test_…`** et **`lomi_pk_test_…`** avec `https://sandbox.api.lomi.africa` en développement. Voir **[Paiements en bac à sable](/reference/setup/sandbox-payments)** pour les numéros de carte de test et le comportement attendu.
</Callout>
