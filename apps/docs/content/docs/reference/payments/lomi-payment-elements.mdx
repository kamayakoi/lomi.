...
Detailed endpoint docs: [Payment Intents API](/reference/payments/payment-intents)
...
See [Webhooks Documentation](/reference/payments/webhooks) for setup details.
...
For sandbox test card numbers, mobile money (Wave, MTN MoMo), hosted checkout QA, and test balances, see **[Sandbox payments](/reference/setup/sandbox-payments)**.
