...
description:
  ...
  Magento 2, and PrestaShop use the same public API contract; Shopify is
...
| Concern | Contract |
| --- | --- |
| Base URL | `https://api.lomi.africa/v1` (live) or `https://sandbox.api.lomi.africa/v1` (test) |
...
Before going live, also read [API integration](/reference/setup/integration), [Authentication](/reference/setup/authentication), and [Webhooks](/reference/payments/webhooks) for outbound subscription management.
...
<Cards>
  <Card
    ...
    href="/reference/integrations/mcp"
  />
  <Card
    title="WooCommerce"
    description="WordPress / WooCommerce payment gateway"
    href="/reference/integrations/woocommerce"
  />
  <Card
    title="Magento 2"
    description="Lomi_Payments hosted checkout module"
    href="/reference/integrations/magento"
  />
  <Card
    title="PrestaShop"
    description="PrestaShop 1.7+ module"
    href="/reference/integrations/prestashop"
  />
  <Card
    title="Shopify"
    description="Remix app — work in progress"
    href="/reference/integrations/shopify"
  />
</Cards>

<Callout type="info">
  **Shopify** uses OAuth, embedded admin, and app-managed configuration — see the Shopify page for current limitations and a **Work in progress** notice.
</Callout>
