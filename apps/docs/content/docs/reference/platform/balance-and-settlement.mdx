...
<Callout type="info">
  In the **test** environment, completed payments credit your **dashboard test balance** only—they do not update live withdrawable balances or platform treasury. See **[Sandbox payments](/reference/setup/sandbox-payments)**.
</Callout>
