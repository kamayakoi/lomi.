...
<Callout type="info">
  En environnement **test**, les paiements complétés créditent uniquement votre **solde de test** du tableau de bord—pas le solde retirable live ni la trésorerie plateforme. Voir **[Paiements en bac à sable](/reference/setup/sandbox-payments)**.
</Callout>
