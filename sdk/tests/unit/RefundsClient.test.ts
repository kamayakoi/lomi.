...
describe('RefundsClient', () => {
  ...
  describe('create', () => {
    ...
    it('should create a refund successfully', async () => {
      ...
      const result = await client.create(mockCreateRefundData);
  ...
  describe('get', () => {
    ...
    it('should get a refund successfully', async () => {
      ...
      const result = await client.get(mockRefundId);
  ...
  describe('patch', () => {
    ...
    it('should update a refund successfully', async () => {
      ...
      const result = await client.patch(mockRefundId, mockUpdateData);
